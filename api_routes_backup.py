...
def api_register():
    ...
    new_user = User(
        ...
        is_verified=True,  # Temporarily bypass email verification
    ...
    print(f"✅ [REGISTER] Registration successful! Email verification bypassed for testing.")
    print(f"👤 [REGISTER] User can now login immediately with: {email}")
    print("="*80 + "\n")
    return jsonify({
        'success': True, 
